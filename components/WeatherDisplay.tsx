...
export default function WeatherCard({
  ...
  return (
    <motion.div
      className={cn(
        "w-[28rem] lg:w-[42rem] lg:p-6 dark:text-white text-black rounded-xl",
    ...
    >
      <span className="text-2xl lg:text-4xl font-bold">{cityName}</span>
      <div className="flex flex-col items-start space-y-0">
        <span className="text-[5rem] font-bold">{temperature}°C</span>
      ...
      <div className="flex flex-wrap items-center min-w-[30rem] lg:min-w-5xl text-sm gap-10">
